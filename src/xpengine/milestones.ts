...
interface IMileStone {
  winAuction:number;
  upgradeAuction:number;
  gainPositiveFeedback:number;
  leaveFeedback:number;
  inviteFriend:number;
  shareContent:number;
  userId:string;
};
export namespace MilestoneManager {

  export const initializeUserMilestones = (user:Parse.Object) => {
  ...
  const incrementSave = (pobject: Parse.Object, propertyName: string) => {
    ...
    pobject.save().then((milestone) => {
      const milestoneAmount = milestone.get(propertyName) as number;
      const player = {};
      switch (propertyName) {
        case "winAuction":
  ...
  export const updateMilestone = (userId:string, milestoneName:string) => {
  ...
  function validateWinAuction (player, milestoneAmount:number) {
  ...
  function validateUpgradeAuction (player, milestoneAmount:number) {
    switch(milestoneAmount) {
      case 1:
        player.expSignal.dispatch({
  ...
  function validateGainPositiveFeedBack(player, milestoneAmount:number) {
    switch(milestoneAmount) {
      case 1:
        player.expSignal.dispatch({
  ...
  function validateLeaveFeedback(player, milestoneAmount:number) {
    switch(milestoneAmount) {
      case 10:
        player.expSignal.dispatch({
  ...
  function validateInviteFriend(player, milestoneAmount:number) {
    switch(milestoneAmount) {
      case 1:
        player.expSignal.dispatch({
          type: "invite1friend",
  ...
  function validateShareContent(player, milestoneAmount:number) {
    switch(milestoneAmount) {
      case 1:
        player.expSignal.dispatch({
          type: "share1content",
