...
export class SceneSplash extends Phaser.State {
    ...
    loadSpriteSheets() {
        ...
        [
            ...
            this.game.load.atlasJSONHash(`${atlasMap}`, `./assets/images/${atlasMap}.png`, `./assets/data/${atlasMap}.json`);
        });
    ...
    loadJsonData() {
        ...
        //this.game.load.text('Isometrics', './assets/data/isometrics.json');
        ...
        [
            ...
            this.game.load.text(`${data}`, `./assets/data/${data}.json`);
        });
